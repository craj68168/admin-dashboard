      ...
      <div className="flex items-center gap-3 self-start sm:self-auto">
        ...
        {user && (
          <Link
            ...
            className="group flex items-center gap-3 rounded-xl border border-slate-200/80 bg-white/80 px-2.5 py-2 shadow-sm transition-all hover:border-blue-200 hover:bg-blue-50/60 hover:shadow-md"
          >
